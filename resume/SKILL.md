...
|-------------------|------------------|
| "신규 기능 기획에 참여했습니다" | "온보딩 이탈률이 업계 대비 높던 상황(S)에서 가입 퍼널 개선 과제(T)를 맡아, 이탈 구간을 데이터로 특정하고 3단계→1단계로 재설계(A)하여 가입 완료율 42%→61%, D7 리텐션 8%p 개선(R)" |
| "팀 프로젝트를 성공적으로 완료했습니다" | "8개 유관부서가 얽힌 결제 개편(S)에서 PM으로 요구사항 정의부터 출시까지 주도(T), 스코프를 MVP로 잘라 우선순위를 합의(A)하여 예정 대비 3주 조기 출시, 결제 전환율 2.2%→4.5%(R)" |
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━
"전환을 개선했습니다" (PM/기획)
→ "가입 완료율 42% → 61%, 결제 전환 2.3%p 상승"

"리텐션을 높였습니다" (PM/기획)
→ "D7 리텐션 24% → 32%, 월 이탈률 9% → 6%"

"지표로 우선순위를 정했습니다" (PM/기획)
→ "임팩트/공수 스코어링으로 백로그 40건 → 실행 8건 선별, 분기 목표 지표 112% 달성"
...
"프로젝트를 성공적으로 완료했습니다"
→ "4개월 간 8개 유관부서 조율, 예정 대비 3주 조기 출시, MAU 1,200 → 4,500"
━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```
...
After:
  "B2B SaaS 프로덕트 매니저 (2023.03~2024.06)
   - 온보딩 퍼널 재설계로 가입 완료율 42% → 61%
   - 결제 개편 PM 리드(8개 유관부서 조율), 결제 전환 2.3%p 상승·3주 조기 출시
   - 지표 기반 백로그 우선순위화(임팩트/공수), 분기 목표 지표 112% 달성"

변경 이유:
  1. 추상적 서술 → 담당 제품·역할+성과 지표
  2. "좋은 성과" → before→after 정량 지표(전환·리텐션·조기출시)
